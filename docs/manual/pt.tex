...
\begin{notice}
\key{Ctrl+Alt+T} abre o Inkline diretamente no tablet.\par
...
Se uma aplicação de atalho ocupar o ecrã, \key{Ctrl+Alt+T} regressa ao Inkline.
Numa emergência, mantenha \key{Ctrl+Alt+Backspace durante dois segundos}.
...
\key{Ctrl+Alt+E} abre o Emacs numa posição livre.
...
\begin{notice}
\key{Ctrl+Alt+T é permanente.} Não pode ser registado nem removido.
...
\key{Emergência:} mantenha Ctrl+Alt+Backspace dois segundos para parar a
