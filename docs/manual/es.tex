...
\begin{notice}
\key{Ctrl+Alt+T} abre Inkline desde la propia tableta.\par
...
Si una aplicación lanzada por atajo ocupa la pantalla, \key{Ctrl+Alt+T} vuelve a Inkline.
En caso de emergencia, mantenga \key{Ctrl+Alt+Backspace durante dos segundos}.
...
\key{Ctrl+Alt+E} abre Emacs en una posición libre.
...
\begin{notice}
\key{Ctrl+Alt+T es permanente.} No se puede registrar ni eliminar.
...
\key{Emergencia:} mantenga Ctrl+Alt+Backspace dos segundos para detener la
