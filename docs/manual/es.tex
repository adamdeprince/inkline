...
La vista previa reciente está en RAM; no es un documento guardado ni una copia
del editor receptor. Flechas y atajos de edición actúan allí. Alt/Opt derecho+C
copia la vista previa; V envía el portapapeles de Inkline. Corte en el editor
receptor. Una confirmación USB no demuestra qué mostró el editor.

\topic{Enviar archivos y restaurar la red}
Las órdenes están en \path{~/.local/bin}. En SSH estándar también puede usar
\code{~/inkline usb} y \code{~/inkline type}. Se conservan las herramientas Outpost.
\UsbExamples
