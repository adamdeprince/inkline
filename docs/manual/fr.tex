...
\begin{notice}
\key{Ctrl+Alt+T} ouvre Inkline directement sur la tablette.\par
...
Si une application de raccourci occupe l'écran, \key{Ctrl+Alt+T} revient à Inkline.
En urgence, maintenez \key{Ctrl+Alt+Backspace pendant deux secondes}.
...
\key{Ctrl+Alt+E} ouvre Emacs dans un emplacement libre.
...
\begin{notice}
\key{Ctrl+Alt+T est permanent.} Impossible de l'enregistrer ou de le retirer.
...
\key{Urgence :} maintenez Ctrl+Alt+Backspace deux secondes pour arrêter
