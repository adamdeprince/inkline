...
\begin{notice}
\key{Strg+Alt+T} öffnet Inkline direkt auf dem Tablet.\par
...
Belegt eine per Kürzel gestartete App den Bildschirm, führt \key{Strg+Alt+T}
zu Inkline zurück. Im Notfall \key{Strg+Alt+Backspace zwei Sekunden halten}.
...
\key{Strg+Alt+E} öffnet Emacs auf einem freien Platz.
...
\begin{notice}
\key{Strg+Alt+T ist fest reserviert.} Registrieren und Entfernen sind gesperrt.
...
\key{Notfall:} Strg+Alt+Backspace zwei Sekunden halten, um die App samt
