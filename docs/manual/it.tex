...
\begin{notice}
\key{Ctrl+Opt+Alt+T} apre Inkline direttamente dal tablet.\par
...
Se un'app avviata da una scorciatoia occupa lo schermo, \key{Ctrl+Opt+Alt+T} torna a Inkline.
Per il recupero d'emergenza, tieni premuto \key{Ctrl+Opt+Alt+Backspace per due secondi}.
...
Tutte le scorciatoie globali usano ora Ctrl+Opt+Alt, incluse T e il recupero tenendo premuto Backspace. Usa il tasto Opt separato del Folio; sulle tastiere USB usa Windows/Command (Super). Ctrl+Alt resta disponibile per Emacs. Chiudi e riapri Inkline dopo l’aggiornamento; l’installazione conserva i terminali aperti.
...
\key{Ctrl+Opt+Alt+E} apre Emacs in uno slot libero.
...
\begin{notice}
\key{Ctrl+Opt+Alt+T è permanente.} Non si può registrare né rimuovere.
Ferma l'app nativa e torna ai terminali esistenti. Usa un tasto Ctrl fisico;
la rimappatura di Caps Lock vale soltanto dentro Inkline.
\end{notice}

\key{Emergenza:} tieni Ctrl+Opt+Alt+Backspace per due secondi per fermare l'app
